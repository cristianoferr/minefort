...
namespace Rimworld.Entities
{
    ...
    public class CharacterSpriteController : BaseSpriteController<GameCharacter>
    {
        ...
        public override void RemoveAll()
        {
            ...
            foreach (GameCharacter c in world.CharacterManager)
            {
        ...
        protected override void OnCreated(GameCharacter character)
        {
        ...
        // Add material with color replacement shader, and generate color replacement texture
        private Material GetMaterial(GameCharacter character)
        {
