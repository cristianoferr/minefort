...
public class Furniture : PhysicalEntity, ISelectable, IPrototypable, IContextActionProvider, IBuildable, IUpdatable
{
    ...
    public RequestedItem[] AcceptsForStorage()
    {
        ...
        foreach (GameInventory inventoryProto in PrototypeManager.Inventory.Values)
        {
    ...
    public void Uninstall()
    {
        ...
        {
            World.Current.InventoryManager.PlaceInventoryAround(Tile, new GameInventory(Type, 1));
        }
