...
namespace Rimworld.Entities
{
    ...
    /// </summary>
    [MoonSharpUserData]
    public class CharacterManager : IEnumerable<GameCharacter>
    {
        /// <summary>
        ...
        /// </summary>
        public event Action<GameCharacter> Created;
        ...
        public IEnumerable<GameCharacter> GetAllFromName(string name)
        {
        ...
        public GameCharacter GetFromID(int id)
        {
        ...
        IEnumerator<GameCharacter> IEnumerable<GameCharacter>.GetEnumerator()
        {
