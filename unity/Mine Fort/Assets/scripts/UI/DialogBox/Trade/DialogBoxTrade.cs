...
public class DialogBoxTrade : DialogBox
{
    ...
    public void DoTradingTestWithMockTraders()
    {
        ...
        Trader mockPlayer = new Trader
        {
            ...
            {
                new GameInventory("Steel Plate", 10) { BasePrice = 3f },
                new GameInventory("Raw Iron", 90) { BasePrice = 0.2f },
            }
        };
        ...
        Trader mockTrader = new Trader
        {
            ...
            Stock = new List<GameInventory>
            {
                new GameInventory("Steel Plate", 40) { BasePrice = 3f },
                new GameInventory("Steel Plate", 40) { BasePrice = 3f },
                new GameInventory("Oxygen Bottle", 10) { BasePrice = 50f },
            }
        };
